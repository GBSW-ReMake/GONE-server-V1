...
/**
 * {@code GET /api/v1/outings}(오늘 전체 현황 조회)의 인가(@PreAuthorize) 통합 테스트(#98).
 *
 * <p>{@code OutingActiveListAuthorizationTest}와 같은 이유로, {@code @WebMvcTest} 슬라이스가
 * 아니라 실제 필터 체인(+ {@code @EnableMethodSecurity})을 통해 검증한다.
 */
@SpringBootTest
@AutoConfigureMockMvc
class OutingDailyOverviewAuthorizationTest {
