...
/**
 * {@code PATCH /api/v1/outings/{code}/reject}의 인가(@PreAuthorize) 통합 테스트.
 *
...
class OutingRejectAuthorizationTest {

  private static final String VALID_BODY = "{\"rejectedReason\": \"지금은 곤란해요\"}";
  ...
  void returns401WithoutToken() throws Exception {
    mockMvc.perform(patch("/api/v1/outings/ANYCODE0001/reject")
