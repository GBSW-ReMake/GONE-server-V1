...
/**
 * {@code POST /api/v1/outings/{code}/return}의 인가(@PreAuthorize) 통합 테스트(#43).
 *
...
class OutingReturnAuthorizationTest {
  ...
  void returns401WithoutToken() throws Exception {
    mockMvc.perform(post("/api/v1/outings/ANYCODE0001/return")
